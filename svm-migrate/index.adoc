...
h| Source h| Destination h| ONTAP 9.11.1 and earlier h| ONTAP 9.12.1 h| ONTAP 9.13.1
...
* The source and destination clusters must have ONTAP One or the former Data Protection Bundle license installed.
